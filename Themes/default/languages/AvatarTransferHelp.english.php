...
$helptxt['avatar_transfer'] = 'Enabling this checkbox and selecting Save will transfer all member uploaded avatars to the Misc_Avatar directory.<br />This process is permanent and is not reversable.';
