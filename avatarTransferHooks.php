...
add_integration_function('integrate_modify_avatar_settings', '$sourcedir/AvatarTransfer.php|avatar_transfer_avatar');
add_integration_function('integrate_helpadmin', '$sourcedir/AvatarTransfer.php|avatar_transfer_help');
?>